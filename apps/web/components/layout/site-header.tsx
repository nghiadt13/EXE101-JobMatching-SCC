    ...
    <header className="sticky top-0 z-50 border-b border-gray-100 bg-white shadow-sm">
      <nav className="flex h-20 w-full items-center justify-between gap-4 px-4 sm:px-8 lg:px-12">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          <button
            className="transition-standard group relative rounded-full p-3 text-slate-600 hover:bg-primary-50 hover:text-primary-600"
            type="button"
          >
            <i className="fa-regular fa-bell text-[22px]" />
