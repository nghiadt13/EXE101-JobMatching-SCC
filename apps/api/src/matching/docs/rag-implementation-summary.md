...
* **Mục tiêu:** Quét hàng ngàn CV trong tích tắc để lọc ra Top N CV phù hợp nhất cho một Job (hoặc Top N Job cho một CV). Đóng vai trò là "Tấm lưới lọc khổng lồ" trước khi đưa vào "Mũi khoan tinh xảo" LLM.
